...
<body>
 ...
 <form action="#" method="post">
  ...
  <p><font color = "red"> <h7> REVOKE Access To User </h7></font></p>
userid: <input type="number" name="uid"/>
 object Id : <input type="number" name="oid"/>
  
  <input type="submit" value = "REVOKE" name="SubmitButton2"/>
 </form> 
...
$uid = $_POST['uid'];
$access = $_POST['access'];
$sql = "DELETE FROM acm WHERE uid='$uid' and oid='$oid'";
